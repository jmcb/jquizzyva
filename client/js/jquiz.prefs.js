var preferences = function ()
{
    ...
    var dia = $("<div>").append($("<p>Set jQuizzyva preferences:</p>")).append(table).addClass("jquiz_dialog").dialog({modal: true, buttons: {"OK": get_lexicon}, close: get_lexicon, width: 500}).dialog("open")
